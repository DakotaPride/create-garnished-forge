...
public class GarnishedCreativeModeTab extends CreativeModeTab {
    ...
    public void fillItemList(@NotNull NonNullList<ItemStack> items) {
        ...
        items.add(GarnishedFluids.ORANGE_MASTIC_RESIN.getBucket().get().getDefaultInstance());
        items.add(GarnishedFluids.YELLOW_MASTIC_RESIN.getBucket().get().getDefaultInstance());
