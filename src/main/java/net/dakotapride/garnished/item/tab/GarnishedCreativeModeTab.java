...
public class GarnishedCreativeModeTab extends CreativeModeTab {
    ...
    public void fillItemList(@NotNull NonNullList<ItemStack> output) {
        ...
        output.add(GarnishedItems.MASTIC_RESIN_LIME.asStack());
        output.add(GarnishedItems.MASTIC_RESIN_BLUE.asStack());
        output.add(GarnishedItems.MASTIC_RESIN_LIGHT_BLUE.asStack());
        output.add(GarnishedItems.MASTIC_RESIN_CYAN.asStack());
        output.add(GarnishedItems.MASTIC_RESIN_PURPLE.asStack());
        output.add(GarnishedItems.MASTIC_RESIN_MAGENTA.asStack());
        output.add(GarnishedItems.MASTIC_RESIN_PINK.asStack());
        output.add(GarnishedItems.MASTIC_RESIN_BLACK.asStack());
        output.add(GarnishedItems.MASTIC_RESIN_GRAY.asStack());
        output.add(GarnishedItems.MASTIC_RESIN_LIGHT_GRAY.asStack());
        output.add(GarnishedItems.MASTIC_RESIN_WHITE.asStack());
        output.add(GarnishedItems.MASTIC_RESIN_BROWN.asStack());
        ...
        output.add(GarnishedItems.MASTIC_PASTE_LIME.asStack());
        output.add(GarnishedItems.MASTIC_PASTE_BLUE.asStack());
        output.add(GarnishedItems.MASTIC_PASTE_LIGHT_BLUE.asStack());
        output.add(GarnishedItems.MASTIC_PASTE_CYAN.asStack());
        output.add(GarnishedItems.MASTIC_PASTE_PURPLE.asStack());
        output.add(GarnishedItems.MASTIC_PASTE_MAGENTA.asStack());
        output.add(GarnishedItems.MASTIC_PASTE_PINK.asStack());
        output.add(GarnishedItems.MASTIC_PASTE_BLACK.asStack());
        output.add(GarnishedItems.MASTIC_PASTE_GRAY.asStack());
        output.add(GarnishedItems.MASTIC_PASTE_LIGHT_GRAY.asStack());
        output.add(GarnishedItems.MASTIC_PASTE_WHITE.asStack());
        output.add(GarnishedItems.MASTIC_PASTE_BROWN.asStack());
    ...
    public static class Blocks extends CreativeModeTab {
        ...
        public void fillItemList(NonNullList<ItemStack> output) {
            ...
            output.add(GarnishedBlocks.SEPIA_WINDOW.asStack());
            output.add(GarnishedBlocks.SEPIA_WINDOW_PANE.asStack());
            ...
            output.add(GarnishedBlocks.NUT_WINDOW.asStack());
            output.add(GarnishedBlocks.NUT_WINDOW_PANE.asStack());
            ...
            output.add(GarnishedBlocks.NUT_LEAVES.asStack());
            output.add(GarnishedBlocks.UNASSIGNED_NUT_LEAVES.asStack());
            output.add(GarnishedBlocks.CASHEW_LEAVES.asStack());
            output.add(GarnishedBlocks.WALNUT_LEAVES.asStack());
            output.add(GarnishedBlocks.ALMOND_LEAVES.asStack());
            output.add(GarnishedBlocks.PECAN_LEAVES.asStack());
            output.add(GarnishedBlocks.PISTACHIO_LEAVES.asStack());
            output.add(GarnishedBlocks.MACADAMIA_LEAVES.asStack());
            output.add(GarnishedBlocks.BUHG_LEAVES.asStack());
            output.add(GarnishedBlocks.HAZELNUT_LEAVES.asStack());
            output.add(GarnishedBlocks.CHESTNUT_LEAVES.asStack());

            output.add(GarnishedBlocks.CASHEW_SACK.asStack());
            output.add(GarnishedBlocks.WALNUT_SACK.asStack());
            output.add(GarnishedBlocks.ALMOND_SACK.asStack());
            output.add(GarnishedBlocks.PECAN_SACK.asStack());
            output.add(GarnishedBlocks.PISTACHIO_SACK.asStack());
            output.add(GarnishedBlocks.MACADAMIA_SACK.asStack());
            output.add(GarnishedBlocks.BUHG_SACK.asStack());
            output.add(GarnishedBlocks.HAZELNUT_SACK.asStack());
            output.add(GarnishedBlocks.CHESTNUT_SACK.asStack());
            ...
            output.add(GarnishedBlocks.LIME_MASTIC_BLOCK.asStack());
            output.add(GarnishedBlocks.BLUE_MASTIC_BLOCK.asStack());
            output.add(GarnishedBlocks.LIGHT_BLUE_MASTIC_BLOCK.asStack());
            output.add(GarnishedBlocks.CYAN_MASTIC_BLOCK.asStack());
            output.add(GarnishedBlocks.PURPLE_MASTIC_BLOCK.asStack());
            output.add(GarnishedBlocks.MAGENTA_MASTIC_BLOCK.asStack());
            output.add(GarnishedBlocks.PINK_MASTIC_BLOCK.asStack());
            output.add(GarnishedBlocks.BLACK_MASTIC_BLOCK.asStack());
            output.add(GarnishedBlocks.GRAY_MASTIC_BLOCK.asStack());
            output.add(GarnishedBlocks.LIGHT_GRAY_MASTIC_BLOCK.asStack());
            output.add(GarnishedBlocks.WHITE_MASTIC_BLOCK.asStack());
            output.add(GarnishedBlocks.BROWN_MASTIC_BLOCK.asStack());

            output.add(GarnishedBlocks.ZULTANITE.asStack());
            output.add(GarnishedBlocks.ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.RED_ZULTANITE.asStack());
            output.add(GarnishedBlocks.RED_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.RED_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.RED_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.ORANGE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.ORANGE_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.ORANGE_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.ORANGE_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.YELLOW_ZULTANITE.asStack());
            output.add(GarnishedBlocks.YELLOW_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.YELLOW_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.YELLOW_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.GREEN_ZULTANITE.asStack());
            output.add(GarnishedBlocks.GREEN_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.GREEN_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.GREEN_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.LIME_ZULTANITE.asStack());
            output.add(GarnishedBlocks.LIME_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.LIME_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.LIME_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.BLUE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.BLUE_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.BLUE_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.BLUE_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.LIGHT_BLUE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.LIGHT_BLUE_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.LIGHT_BLUE_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.LIGHT_BLUE_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.CYAN_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CYAN_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.CYAN_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.CYAN_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.PURPLE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.PURPLE_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.PURPLE_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.PURPLE_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.MAGENTA_ZULTANITE.asStack());
            output.add(GarnishedBlocks.MAGENTA_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.MAGENTA_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.MAGENTA_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.PINK_ZULTANITE.asStack());
            output.add(GarnishedBlocks.PINK_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.PINK_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.PINK_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.BLACK_ZULTANITE.asStack());
            output.add(GarnishedBlocks.BLACK_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.BLACK_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.BLACK_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.GRAY_ZULTANITE.asStack());
            output.add(GarnishedBlocks.GRAY_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.GRAY_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.GRAY_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.LIGHT_GRAY_ZULTANITE.asStack());
            output.add(GarnishedBlocks.LIGHT_GRAY_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.LIGHT_GRAY_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.LIGHT_GRAY_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.WHITE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.WHITE_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.WHITE_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.WHITE_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.BROWN_ZULTANITE.asStack());
            output.add(GarnishedBlocks.BROWN_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.BROWN_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.BROWN_ZULTANITE_WALL.asStack());

            output.add(GarnishedBlocks.ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.ZULTANITE_BRICK_WALL.asStack());
            output.add(GarnishedBlocks.RED_ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.RED_ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.RED_ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.RED_ZULTANITE_BRICK_WALL.asStack());
            output.add(GarnishedBlocks.ORANGE_ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.ORANGE_ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.ORANGE_ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.ORANGE_ZULTANITE_BRICK_WALL.asStack());
            output.add(GarnishedBlocks.YELLOW_ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.YELLOW_ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.YELLOW_ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.YELLOW_ZULTANITE_BRICK_WALL.asStack());
            output.add(GarnishedBlocks.GREEN_ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.GREEN_ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.GREEN_ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.GREEN_ZULTANITE_BRICK_WALL.asStack());
            output.add(GarnishedBlocks.LIME_ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.LIME_ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.LIME_ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.LIME_ZULTANITE_BRICK_WALL.asStack());
            output.add(GarnishedBlocks.BLUE_ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.BLUE_ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.BLUE_ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.BLUE_ZULTANITE_BRICK_WALL.asStack());
            output.add(GarnishedBlocks.LIGHT_BLUE_ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.LIGHT_BLUE_ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.LIGHT_BLUE_ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.LIGHT_BLUE_ZULTANITE_BRICK_WALL.asStack());
            output.add(GarnishedBlocks.CYAN_ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.CYAN_ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.CYAN_ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.CYAN_ZULTANITE_BRICK_WALL.asStack());
            output.add(GarnishedBlocks.PURPLE_ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.PURPLE_ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.PURPLE_ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.PURPLE_ZULTANITE_BRICK_WALL.asStack());
            output.add(GarnishedBlocks.MAGENTA_ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.MAGENTA_ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.MAGENTA_ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.MAGENTA_ZULTANITE_BRICK_WALL.asStack());
            output.add(GarnishedBlocks.PINK_ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.PINK_ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.PINK_ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.PINK_ZULTANITE_BRICK_WALL.asStack());
            output.add(GarnishedBlocks.BLACK_ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.BLACK_ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.BLACK_ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.BLACK_ZULTANITE_BRICK_WALL.asStack());
            output.add(GarnishedBlocks.GRAY_ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.GRAY_ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.GRAY_ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.GRAY_ZULTANITE_BRICK_WALL.asStack());
            output.add(GarnishedBlocks.LIGHT_GRAY_ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.LIGHT_GRAY_ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.LIGHT_GRAY_ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.LIGHT_GRAY_ZULTANITE_BRICK_WALL.asStack());
            output.add(GarnishedBlocks.WHITE_ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.WHITE_ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.WHITE_ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.WHITE_ZULTANITE_BRICK_WALL.asStack());
            output.add(GarnishedBlocks.BROWN_ZULTANITE_BRICKS.asStack());
            output.add(GarnishedBlocks.BROWN_ZULTANITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.BROWN_ZULTANITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.BROWN_ZULTANITE_BRICK_WALL.asStack());

            output.add(GarnishedBlocks.POLISHED_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.POLISHED_RED_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_RED_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_RED_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_RED_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.POLISHED_ORANGE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_ORANGE_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_ORANGE_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_ORANGE_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.POLISHED_YELLOW_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_YELLOW_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_YELLOW_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_YELLOW_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.POLISHED_GREEN_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_GREEN_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_GREEN_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_GREEN_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.POLISHED_LIME_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_LIME_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_LIME_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_LIME_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.POLISHED_BLUE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_BLUE_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_BLUE_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_BLUE_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.POLISHED_LIGHT_BLUE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_LIGHT_BLUE_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_LIGHT_BLUE_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_LIGHT_BLUE_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.POLISHED_CYAN_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_CYAN_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_CYAN_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_CYAN_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.POLISHED_PURPLE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_PURPLE_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_PURPLE_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_PURPLE_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.POLISHED_MAGENTA_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_MAGENTA_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_MAGENTA_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_MAGENTA_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.POLISHED_PINK_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_PINK_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_PINK_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_PINK_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.POLISHED_BLACK_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_BLACK_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_BLACK_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_BLACK_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.POLISHED_GRAY_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_GRAY_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_GRAY_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_GRAY_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.POLISHED_LIGHT_GRAY_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_LIGHT_GRAY_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_LIGHT_GRAY_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_LIGHT_GRAY_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.POLISHED_WHITE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_WHITE_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_WHITE_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_WHITE_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.POLISHED_BROWN_ZULTANITE.asStack());
            output.add(GarnishedBlocks.POLISHED_BROWN_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.POLISHED_BROWN_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.POLISHED_BROWN_ZULTANITE_WALL.asStack());

            output.add(GarnishedBlocks.SMOOTH_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.SMOOTH_RED_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_RED_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_RED_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_RED_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.SMOOTH_ORANGE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_ORANGE_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_ORANGE_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_ORANGE_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.SMOOTH_YELLOW_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_YELLOW_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_YELLOW_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_YELLOW_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.SMOOTH_GREEN_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_GREEN_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_GREEN_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_GREEN_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.SMOOTH_LIME_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_LIME_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_LIME_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_LIME_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.SMOOTH_BLUE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_BLUE_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_BLUE_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_BLUE_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.SMOOTH_LIGHT_BLUE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_LIGHT_BLUE_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_LIGHT_BLUE_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_LIGHT_BLUE_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.SMOOTH_CYAN_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_CYAN_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_CYAN_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_CYAN_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.SMOOTH_PURPLE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_PURPLE_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_PURPLE_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_PURPLE_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.SMOOTH_MAGENTA_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_MAGENTA_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_MAGENTA_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_MAGENTA_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.SMOOTH_PINK_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_PINK_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_PINK_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_PINK_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.SMOOTH_BLACK_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_BLACK_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_BLACK_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_BLACK_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.SMOOTH_GRAY_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_GRAY_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_GRAY_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_GRAY_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.SMOOTH_LIGHT_GRAY_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_LIGHT_GRAY_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_LIGHT_GRAY_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_LIGHT_GRAY_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.SMOOTH_WHITE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_WHITE_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_WHITE_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_WHITE_ZULTANITE_WALL.asStack());
            output.add(GarnishedBlocks.SMOOTH_BROWN_ZULTANITE.asStack());
            output.add(GarnishedBlocks.SMOOTH_BROWN_ZULTANITE_SLAB.asStack());
            output.add(GarnishedBlocks.SMOOTH_BROWN_ZULTANITE_STAIRS.asStack());
            output.add(GarnishedBlocks.SMOOTH_BROWN_ZULTANITE_WALL.asStack());

            output.add(GarnishedBlocks.CHISELED_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CHISELED_RED_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CHISELED_ORANGE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CHISELED_YELLOW_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CHISELED_GREEN_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CHISELED_LIME_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CHISELED_BLUE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CHISELED_LIGHT_BLUE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CHISELED_CYAN_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CHISELED_PURPLE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CHISELED_MAGENTA_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CHISELED_PINK_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CHISELED_BLACK_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CHISELED_GRAY_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CHISELED_LIGHT_GRAY_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CHISELED_WHITE_ZULTANITE.asStack());
            output.add(GarnishedBlocks.CHISELED_BROWN_ZULTANITE.asStack());
            ...
            output.add(GarnishedBlocks.ABYSSAL_STONE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.ABYSSAL_STONE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.ABYSSAL_STONE_BRICK_WALL.asStack());
            ...
            output.add(GarnishedBlocks.CARNOTITE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.CARNOTITE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.CARNOTITE_BRICK_WALL.asStack());
            ...
            output.add(GarnishedBlocks.UNSTABLE_STONE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.UNSTABLE_STONE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.UNSTABLE_STONE_BRICK_WALL.asStack());
            ...
            output.add(GarnishedBlocks.RITUALISTIC_STONE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.RITUALISTIC_STONE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.RITUALISTIC_STONE_BRICK_WALL.asStack());
            ...
            output.add(GarnishedBlocks.DRAGON_STONE_BRICK_SLAB.asStack());
            output.add(GarnishedBlocks.DRAGON_STONE_BRICK_STAIRS.asStack());
            output.add(GarnishedBlocks.DRAGON_STONE_BRICK_WALL.asStack());
