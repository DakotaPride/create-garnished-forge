...
public class NutBoatItem extends Item {
    private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);
    private final NutBoatEntity.Type type;

    public NutBoatItem(Item.Properties pProperties) {
        super(pProperties.stacksTo(1));
        this.type = NutBoatEntity.Type.NUT;
    }
    ...
    private Boat getBoat(Level p_220017_, HitResult p_220018_) {
        return new NutBoatEntity(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z);
    }
}