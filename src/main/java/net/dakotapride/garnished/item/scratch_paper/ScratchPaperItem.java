...
public class ScratchPaperItem extends Item implements CustomUseEffectsItem {
    MobEffect effect;
    Supplier<Item> utility;
    ItemStack particleStack;

    public ScratchPaperItem(MobEffect effect, Supplier<Item> utilityItem, Properties pProperties) {
        super(pProperties.defaultDurability(16));
        this.effect = effect;
        this.utility = utilityItem;
        this.particleStack = utilityItem.get().getDefaultInstance();
    }

    public ScratchPaperItem(MobEffect effect, Supplier<Item> utilityItem, ItemStack particleStack, Properties pProperties) {
        super(pProperties.defaultDurability(16));
        this.effect = effect;
        this.utility = utilityItem;
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(@NotNull Level level, Player player, @NotNull InteractionHand hand) {
        ...
        if (player.hasEffect(effect) && itemInOtherHand.is(utility.get())) {
