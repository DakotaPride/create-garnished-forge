...
public class NutBoatEntity extends Boat {
    ...
    public NutBoatEntity(Level level, double pX, double pY, double pZ) {
        this(GarnishedEntities.NUT_BOAT.get(), level);
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.NUT.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
         ...
         */
        public static NutBoatEntity.Type byId(int pId) {
            NutBoatEntity.Type[] aboat$type = values();
        ...
        public static NutBoatEntity.Type byName(String pName) {
            NutBoatEntity.Type[] aboat$type = values();
