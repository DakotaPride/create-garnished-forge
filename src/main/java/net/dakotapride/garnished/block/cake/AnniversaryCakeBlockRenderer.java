	...
	public void render(AnniversaryCakeBlockEntity blockEntity, float tick, @NotNull PoseStack poseStack,
		...
		if (blockEntity.getBlockState().getValue(AnniversaryCakeBlock.BITES_PROPERTY) != 7) {
			...
			if (hasLessThanOneBite) {
				...
				itemRenderer.renderStatic(topper, ItemTransforms.TransformType.NONE, light, overlay, poseStack, buffer, 1);
				poseStack.popPose();
				...
				itemRenderer.renderStatic(pistachio, ItemTransforms.TransformType.NONE, light, overlay, poseStack, buffer, 1);
				poseStack.popPose();
			}
			...
			if (hasLessThanTwoBites) {
				...
				poseStack.mulPose(Vector3f.XP.rotationDegrees(10));
				itemRenderer.renderStatic(hazelnut, ItemTransforms.TransformType.NONE, light, overlay, poseStack, buffer, 1);
				poseStack.popPose();
				...
				poseStack.mulPose(Vector3f.XP.rotationDegrees(-10));
				itemRenderer.renderStatic(peanut, ItemTransforms.TransformType.NONE, light, overlay, poseStack, buffer, 1);
				poseStack.popPose();
			}
			...
			if (hasLessthanThreeBites) {
				...
				itemRenderer.renderStatic(cashew, ItemTransforms.TransformType.NONE, light, overlay, poseStack, buffer, 1);
				poseStack.popPose();
				...
				// poseStack.mulPose(Vector3f.YP.rotationDegrees(0));
				poseStack.mulPose(Vector3f.XP.rotationDegrees(-10));
				itemRenderer.renderStatic(pecan, ItemTransforms.TransformType.NONE, light, overlay, poseStack, buffer, 1);
				poseStack.popPose();
				...
				poseStack.mulPose(Vector3f.YP.rotationDegrees(90));
				poseStack.mulPose(Vector3f.XP.rotationDegrees(10));
				itemRenderer.renderStatic(macadamia, ItemTransforms.TransformType.NONE, light, overlay, poseStack, buffer, 1);
				poseStack.popPose();
			}
			...
			if (hasLessThanFourBites) {
				...
				poseStack.mulPose(Vector3f.YP.rotationDegrees(45));
				poseStack.mulPose(Vector3f.XP.rotationDegrees(-10));
				itemRenderer.renderStatic(walnut, ItemTransforms.TransformType.NONE, light, overlay, poseStack, buffer, 1);
				poseStack.popPose();
				...
				poseStack.mulPose(Vector3f.YP.rotationDegrees(-45));
				poseStack.mulPose(Vector3f.XP.rotationDegrees(10));
				itemRenderer.renderStatic(almond, ItemTransforms.TransformType.NONE, light, overlay, poseStack, buffer, 1);
				poseStack.popPose();
				...
				poseStack.mulPose(Vector3f.YP.rotationDegrees(90));
				poseStack.mulPose(Vector3f.XP.rotationDegrees(-10));
				itemRenderer.renderStatic(chestnut, ItemTransforms.TransformType.NONE, light, overlay, poseStack, buffer, 1);
				poseStack.popPose();
			}
		}
	}
