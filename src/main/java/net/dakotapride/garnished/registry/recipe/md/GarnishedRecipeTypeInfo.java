...
public class GarnishedRecipeTypeInfo<R extends Recipe<?>> implements IRecipeTypeInfo {
    ...
    public GarnishedRecipeTypeInfo(String name, Supplier<? extends RecipeSerializer<R>> serializerSupplier,
