...
public class GarnishedPonderIndex {
    ...
    public static void index() {
        ...
        HELPER.forComponents(GarnishedItems.WOODEN_HATCHET, GarnishedItems.STONE_HATCHET, GarnishedItems.IRON_HATCHET, GarnishedItems.GOLDEN_HATCHET,
                GarnishedItems.DIAMOND_HATCHET, GarnishedItems.NETHERITE_HATCHET, GarnishedItems.BLAZING_HATCHET, GarnishedItems.BRASS_HATCHET,
                GarnishedItems.COPPER_HATCHET, GarnishedItems.EXPERIENCE_HATCHET, GarnishedItems.GILDED_NETHERITE_HATCHET, GarnishedItems.ROSE_GOLD_HATCHET,
                GarnishedItems.ROSE_QUARTZ_HATCHET, GarnishedItems.ZINC_HATCHET, GarnishedItems.WARDEN_HATCHET)
    ...
    public static class Tags {
        public static PonderTag
                RECENT_CHANGES = create("recent_changes").item(GarnishedItems.BUHG)
                        .defaultLang("recent_changes", "recent_changes_description")
                        .addToIndex(),
                KELP_RELATED = create("kelp_related").item(GarnishedItems.DRIED_VERMILION_KELP)
                        .defaultLang("kelp_entries", "kelp_entries_description")
                        .addToIndex(),
                MASTIC_RESIN = create("mastic_resin").item(GarnishedItems.MASTIC_RESIN)
                        .defaultLang("mastic_resin", "mastic_resin_description")
                        .addToIndex(),
                CRACKED_NUTS = create("cracked_nuts").item(GarnishedItems.CRACKED_WALNUT)
                        .defaultLang("cracked_nuts", "cracked_nuts_description")
                        .addToIndex(),
                HATCHETS = create("hatchets").item(GarnishedItems.IRON_HATCHET)
                        .defaultLang("hatchets", "hatchets_description")
                        .addToIndex(),
                CRUSHED_NETHER_INGREDIENTS = create("crushed_nether_ingredients").item(GarnishedItems.BRITTLE_DUST)
                        .defaultLang("crushed_nether_ingredients", "crushed_nether_ingredients_description")
                        .addToIndex(),
                FLUIDS = create("fluids").item(GarnishedItems.BOTTLED_PEANUT_OIL)
        ...
        public static void fillPonderTags() {
            ...
            PonderRegistry.TAGS.forTag(HATCHETS)
                    ...
                    .add(GarnishedItems.BLAZING_HATCHET)
                    .add(GarnishedItems.BRASS_HATCHET)
                    .add(GarnishedItems.COPPER_HATCHET)
                    .add(GarnishedItems.EXPERIENCE_HATCHET)
                    .add(GarnishedItems.GILDED_NETHERITE_HATCHET)
                    .add(GarnishedItems.ROSE_GOLD_HATCHET)
                    .add(GarnishedItems.ROSE_QUARTZ_HATCHET)
                    .add(GarnishedItems.ZINC_HATCHET)
    ...
    static class ScenesAndInteractions {
        ...
        public static void dulseKelp (SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack itemStack = new ItemStack(GarnishedBlocks.DULSE_KELP.asItem());
            ItemStack itemStack1 = new ItemStack(GarnishedItems.DRIED_DULSE_KELP);
        ...
        public static void vermilionKelp (SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack itemStack = new ItemStack(GarnishedBlocks.VERMILION_KELP.asItem());
            ItemStack itemStack1 = new ItemStack(GarnishedItems.DRIED_VERMILION_KELP);
            Vec3 entitySpawn = util.vector.centerOf(3, 1, 1);
            Vec3 entitySpawn1 = util.vector.centerOf(3, 2, 3);
        ...
        public static void masticResinRecipe(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack masticResin = new ItemStack(GarnishedItems.MASTIC_RESIN);
            ...
            scene.world.modifyBlockEntityNBT(util.select.position(basin), BasinBlockEntity.class, nbt -> {
                nbt.put("VisualizedItems",
                        NBTHelper.writeCompoundList(ImmutableList.of(IntAttached.with(1, masticResin)), ia -> ia.getValue()
                                .serializeNBT()));
            });
            scene.idle(4);
        ...
        public static void colouredMasticResin(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            scene.world.setCraftingResult(util.grid.at(3, 1, 3), new ItemStack(GarnishedItems.MASTIC_RESIN_RED));

            scene.world.modifyBlockEntity(util.grid.at(3, 3, 3), type, mct -> mct.getInventory()
                    .insertItem(0, masticResin.copy(), false));
            scene.world.modifyBlockEntity(util.grid.at(3, 3, 2), type, mct -> mct.getInventory()
                    .insertItem(0, masticResin.copy(), false));
            scene.idle(5);
            scene.world.modifyBlockEntity(util.grid.at(3, 3, 1), type, mct -> mct.getInventory()
                    .insertItem(0, masticResin.copy(), false));
            scene.idle(5);
            scene.world.modifyBlockEntity(util.grid.at(3, 2, 1), type, mct -> mct.getInventory()
                    .insertItem(0, masticResin.copy(), false));
            scene.idle(5);
            scene.world.modifyBlockEntity(util.grid.at(3, 2, 2), type, mct -> mct.getInventory()
                    .insertItem(0, redDye.copy(), false));
            scene.idle(5);
            scene.world.modifyBlockEntity(util.grid.at(3, 2, 3), type, mct -> mct.getInventory()
                    .insertItem(0, masticResin.copy(), false));
            scene.idle(5);
            scene.world.modifyBlockEntity(util.grid.at(3, 1, 3), type, mct -> mct.getInventory()
                    .insertItem(0, masticResin.copy(), false));
            scene.idle(5);
            scene.world.modifyBlockEntity(util.grid.at(3, 1, 2), type, mct -> mct.getInventory()
                    .insertItem(0, masticResin.copy(), false));
            scene.idle(5);
            scene.world.modifyBlockEntity(util.grid.at(3, 1, 1), type, mct -> mct.getInventory()
                    .insertItem(0, masticResin.copy(), false));
            scene.idle(70);
        ...
        public static void masticPaste(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack redMasticResin = new ItemStack(GarnishedItems.MASTIC_RESIN_RED);
            ItemStack redMasticPaste = new ItemStack(GarnishedItems.MASTIC_PASTE_RED);
            ...
            scene.idle(30);
            scene.world.modifyBlockEntity(util.grid.at(2, 3, 3), type, pte -> pte.getPressingBehaviour()
                    .makePressingParticleEffect(util.grid.at(2, 2, 3).below().getCenter().add(0, 8 / 16f, 0), redMasticResin));
            ...
            ItemStack redMasticResinBlock = new ItemStack(GarnishedBlocks.RED_MASTIC_BLOCK);
            ...
            scene.world.modifyBlockEntityNBT(util.select.position(util.grid.at(2, 2, 1)), BasinBlockEntity.class, nbt -> {
                nbt.put("VisualizedItems",
                        NBTHelper.writeCompoundList(ImmutableList.of(IntAttached.with(1, redMasticResinBlock)), ia -> ia.getValue()
                                .serializeNBT()));
            });
            scene.idle(4);
        ...
        public static void masticFluid(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            scene.world.modifyBlockEntity(util.grid.at(1, 1, 3), FluidTankBlockEntity.class, be -> be.getTankInventory()
                    .fill(fluid(GarnishedFluids.RED_MASTIC_RESIN.get().getSource(), 250), IFluidHandler.FluidAction.EXECUTE));

            scene.world.modifyBlockEntity(util.grid.at(3, 4, 3), type, MechanicalMixerBlockEntity::startProcessingBasin);
            scene.world.createItemOnBeltLike(util.grid.at(3, 2, 3), Direction.UP, redMasticResinBlock);
            scene.idle(15);
            scene.world.modifyBlockEntity(util.grid.at(1, 1, 3), FluidTankBlockEntity.class, be -> be.getTankInventory()
                    .fill(fluid(GarnishedFluids.RED_MASTIC_RESIN.get().getSource(), 500), IFluidHandler.FluidAction.EXECUTE));

            scene.world.modifyBlockEntity(util.grid.at(3, 4, 3), type, MechanicalMixerBlockEntity::startProcessingBasin);
            scene.world.createItemOnBeltLike(util.grid.at(3, 2, 3), Direction.UP, redMasticResinBlock);
            scene.idle(15);
            scene.world.modifyBlockEntity(util.grid.at(1, 1, 3), FluidTankBlockEntity.class, be -> be.getTankInventory()
                    .fill(fluid(GarnishedFluids.RED_MASTIC_RESIN.get().getSource(), 750), IFluidHandler.FluidAction.EXECUTE));

            scene.world.modifyBlockEntity(util.grid.at(3, 4, 3), type, MechanicalMixerBlockEntity::startProcessingBasin);
            scene.world.createItemOnBeltLike(util.grid.at(3, 2, 3), Direction.UP, redMasticResinBlock);
            scene.idle(15);
            scene.world.modifyBlockEntity(util.grid.at(1, 1, 3), FluidTankBlockEntity.class, be -> be.getTankInventory()
                    .fill(fluid(GarnishedFluids.RED_MASTIC_RESIN.get().getSource(), 1000), IFluidHandler.FluidAction.EXECUTE));

            scene.world.modifyBlockEntity(util.grid.at(3, 4, 3), type, MechanicalMixerBlockEntity::startProcessingBasin);
            scene.world.createItemOnBeltLike(util.grid.at(3, 2, 3), Direction.UP, redMasticResinBlock);
            scene.idle(15);
            scene.world.modifyBlockEntity(util.grid.at(1, 1, 3), FluidTankBlockEntity.class, be -> be.getTankInventory()
                    .fill(fluid(GarnishedFluids.RED_MASTIC_RESIN.get().getSource(), 1250), IFluidHandler.FluidAction.EXECUTE));
            scene.idle(20);
        ...
        public static void millingNuts(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack itemStack = new ItemStack(GarnishedItems.UNGARNISHED_WALNUT);
            Vec3 entitySpawn = util.vector.topOf(util.grid.at(4, 2, 2).above(3));

            ItemStack crackedWalnut = new ItemStack(GarnishedItems.CRACKED_WALNUT);
        ...
        public static void hatchets(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack itemStack = new ItemStack(GarnishedItems.IRON_HATCHET);
        ...
        public static void hatchetAttacking(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack netheriteHatchet = new ItemStack(GarnishedItems.NETHERITE_HATCHET);

            netheriteHatchet.enchant(GarnishedEnchantments.RAVAGING.get(), 0);
            scene.world.modifyBlockEntityNBT(util.select.position(3, 2, 3), teType, nbt -> nbt.put("HeldItem", netheriteHatchet.serializeNBT()));
            ...
            scene.idle(26);
            scene.world.modifyEntity(blaze, entity -> entity.animateHurt(0.0F));
            ...
            ItemStack itemStack = new ItemStack(GarnishedItems.ENFLAMED_MANDIBLE);
            ...
            ItemStack netheriteHatchet1 = new ItemStack(GarnishedItems.NETHERITE_HATCHET);
            ...
            scene.world.moveDeployer(util.grid.at(3, 2, 3), 1, 25);
            scene.idle(26);
            scene.world.modifyEntity(squid, entity -> entity.animateHurt(0.0F));
            // scene.world.modifyEntity(blaze, entity -> entity.hurt(entity.damageSources().generic(), 100.0F));
            scene.idle(7);
        ...
        public static void integratedHatchets(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack roseGoldHatchet = new ItemStack(GarnishedItems.ROSE_GOLD_HATCHET);
            ItemStack wardenHatchet = new ItemStack(GarnishedItems.WARDEN_HATCHET);
            ItemStack gildedNetheriteHatchet = new ItemStack(GarnishedItems.GILDED_NETHERITE_HATCHET);
            Vec3 spawn = util.vector.topOf(util.grid.at(3, 1, 1).above(3));
            Vec3 spawn1 = util.vector.topOf(util.grid.at(2, 1, 3).above(4));
            Vec3 spawn2 = util.vector.topOf(util.grid.at(3, 1, 3).above(2));

            ElementLink<EntityElement> entity = scene.world.createItemEntity(spawn, util.vector.of(0, 0, 0), roseGoldHatchet);
            scene.idle(5);
            ElementLink<EntityElement> entity1 = scene.world.createItemEntity(spawn1, util.vector.of(0, 0, 0), wardenHatchet);
            scene.idle(5);
            ElementLink<EntityElement> entity2 = scene.world.createItemEntity(spawn2, util.vector.of(0, 0, 0), gildedNetheriteHatchet);
            scene.idle(15);
            scene.overlay.showText(80)
                    .attachKeyFrame()
                    .placeNearTarget()
                    .text("integrated_hatchets_basics")
            ...
            scene.overlay.showText(80)
                    .attachKeyFrame()
                    .placeNearTarget()
                    .text("integrated_hatchets_abilities")
        ...
        public static void brittleDust(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack brittleDustStack = new ItemStack(GarnishedItems.BRITTLE_DUST, 2);
        ...
        public static void senileDust(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack stack = new ItemStack(GarnishedItems.BRITTLE_DUST);
            ItemStack output = new ItemStack(GarnishedItems.SENILE_DUST);
        ...
        public static void senileSpread(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack senileSpread = new ItemStack(GarnishedItems.SENILE_SPREAD);
            ItemStack senileDust = new ItemStack(GarnishedItems.SENILE_DUST);
            ItemStack boneMeal = new ItemStack(Items.BONE_MEAL);
            Class<DeployerBlockEntity> teType = DeployerBlockEntity.class;
            scene.world.modifyBlockEntityNBT(util.select.position(3, 3, 2), teType, nbt -> nbt.put("HeldItem", senileDust.serializeNBT()));
        ...
        public static void bottledPeanutOil(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack peanutOil = new ItemStack(GarnishedItems.BOTTLED_PEANUT_OIL);
        ...
        public static void additionalHeatSources(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            scene.overlay.showControls(new InputWindowElement(util.vector.topOf(2, 1, 2), Pointing.RIGHT).rightClick().withItem(new ItemStack(GarnishedItems.UNGARNISHED_BUHG)), 30);
            scene.idle(15);
        ...
        public static void bottledAppleCider(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack appleCider = new ItemStack(GarnishedItems.APPLE_CIDER);
        ...
        public static void appleCiderCreation(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack crackedMacadamia = new ItemStack(GarnishedItems.CRACKED_MACADAMIA);
            ItemStack apple = new ItemStack(Items.APPLE);
            ItemStack garnishCompound = new ItemStack(GarnishedItems.GARNISH_COMPOUND);
            ...
            scene.idle(15);
            scene.world.modifyBlockEntity(util.grid.at(0, 1, 3), FluidTankBlockEntity.class, be -> be.getTankInventory()
                    .fill(fluid(GarnishedFluids.APPLE_CIDER.get().getSource(), 250), IFluidHandler.FluidAction.EXECUTE));

            scene.world.modifyBlockEntity(util.grid.at(3, 4, 3), type, MechanicalMixerBlockEntity::startProcessingBasin);
            scene.idle(15);
            scene.world.modifyBlockEntity(util.grid.at(0, 1, 3), FluidTankBlockEntity.class, be -> be.getTankInventory()
                    .fill(fluid(GarnishedFluids.APPLE_CIDER.get().getSource(), 500), IFluidHandler.FluidAction.EXECUTE));

            scene.world.modifyBlockEntity(util.grid.at(3, 4, 3), type, MechanicalMixerBlockEntity::startProcessingBasin);
            scene.idle(15);
            scene.world.modifyBlockEntity(util.grid.at(0, 1, 3), FluidTankBlockEntity.class, be -> be.getTankInventory()
                    .fill(fluid(GarnishedFluids.APPLE_CIDER.get().getSource(), 750), IFluidHandler.FluidAction.EXECUTE));

            scene.world.modifyBlockEntity(util.grid.at(3, 4, 3), type, MechanicalMixerBlockEntity::startProcessingBasin);
            scene.idle(15);
            scene.world.modifyBlockEntity(util.grid.at(0, 1, 3), FluidTankBlockEntity.class, be -> be.getTankInventory()
                    .fill(fluid(GarnishedFluids.APPLE_CIDER.get().getSource(), 1000), IFluidHandler.FluidAction.EXECUTE));

            scene.world.modifyBlockEntity(util.grid.at(3, 4, 3), type, MechanicalMixerBlockEntity::startProcessingBasin);
            scene.idle(15);
            scene.world.modifyBlockEntity(util.grid.at(0, 1, 3), FluidTankBlockEntity.class, be -> be.getTankInventory()
                    .fill(fluid(GarnishedFluids.APPLE_CIDER.get().getSource(), 1250), IFluidHandler.FluidAction.EXECUTE));
            scene.idle(15);
            scene.overlay.showText(80)
                    .attachKeyFrame()
                    .placeNearTarget()
        ...
        public static void appleCiderMisc(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack cryptic = new ItemStack(GarnishedItems.CRYPTIC_APPLE_CIDER);
            ItemStack bitter = new ItemStack(GarnishedItems.BITTER_APPLE_CIDER);
        ...
        public static void crushingFungus(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack sepia = new ItemStack(GarnishedBlocks.SEPIA_FUNGUS);
            ...
            scene.effects.emitParticles(util.vector.centerOf(util.grid.at(2, 3, 2))
                    .add(0, -0.2, 0), blockSpace, 3, 40);
            scene.idle(24);
            ItemStack crimson1 = new ItemStack(GarnishedItems.CRUSHED_CRIMSON_FUNGUS);
            ItemStack warped1 = new ItemStack(GarnishedItems.CRUSHED_WARPED_FUNGUS);
            ItemStack sepia1 = new ItemStack(GarnishedItems.CRUSHED_SEPIA_FUNGUS);
            ItemStack shroomlight1 = new ItemStack(GarnishedItems.CRUSHED_SHROOMLIGHT);

            ElementLink<EntityElement> crushedCrimsonEntity = scene.world.createItemEntity(util.grid.at(2, 3, 2).getCenter().add(0, -1.4, 0), util.vector.of(0, 0, 0), crimson1);
            scene.idle(4);
            ...
            ElementLink<EntityElement> crushedWarpedEntity = scene.world.createItemEntity(util.grid.at(2, 3, 2).getCenter().add(0, -1.4, 0), util.vector.of(0, 0, 0), warped1);
            scene.idle(4);
            ...
            ElementLink<EntityElement> crushedSepiaEntity = scene.world.createItemEntity(util.grid.at(2, 3, 2).getCenter().add(0, -1.4, 0), util.vector.of(0, 0, 0), sepia1);
            scene.idle(4);
            ...
            ElementLink<EntityElement> crushedShroomlightEntity = scene.world.createItemEntity(util.grid.at(2, 3, 2).getCenter().add(0, -1.4, 0), util.vector.of(0, 0, 0), shroomlight1);
            scene.idle(4);
        ...
        public static void cashewMixtureFluid(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack fermentedCashewMixture = new ItemStack(GarnishedItems.FERMENTED_CASHEW_MIXTURE);
        ...
        public static void cashewSorbetScoopCreation(SceneBuilder scene, SceneBuildingUtil util) {
            ...
            ItemStack nut = new ItemStack(GarnishedItems.CASHEW);
            ...
            ItemStack cashewSorbetScoop = new ItemStack(GarnishedItems.CASHEW_SORBET_SCOOP, 2);
            Class<MechanicalMixerBlockEntity> type = MechanicalMixerBlockEntity.class;
