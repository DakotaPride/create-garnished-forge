...
public class GarnishedPonderIndex {
	...
	public static class Tags {
		public static PonderTag
				RECENT_CHANGES = create("recent_changes").item(GarnishedItems.BUHG.get())
				.defaultLang("recent_changes", "recent_changes_description")
				.addToIndex(),
				KELP_RELATED = create("kelp_related").item(GarnishedItems.DRIED_VERMILION_KELP.get())
						.defaultLang("kelp_entries", "kelp_entries_description")
						.addToIndex(),
				MASTIC_RESIN = create("mastic_resin").item(GarnishedItems.MASTIC_RESIN.get())
						.defaultLang("mastic_resin", "mastic_resin_description")
						.addToIndex(),
				CRACKED_NUTS = create("cracked_nuts").item(GarnishedItems.CRACKED_WALNUT.get())
						.defaultLang("cracked_nuts", "cracked_nuts_description")
						.addToIndex(),
				HATCHETS = create("hatchets").item(GarnishedItems.IRON_HATCHET.get())
						.defaultLang("hatchets", "hatchets_description")
						.addToIndex(),
				CRUSHED_NETHER_INGREDIENTS = create("crushed_nether_ingredients").item(GarnishedItems.BRITTLE_DUST.get())
	...
	static class ScenesAndInteractions {
		...
		public static void hatchetAttacking(SceneBuilder scene, SceneBuildingUtil util) {
			...
			scene.world.moveDeployer(util.grid.at(3, 2, 3), 1, 25);
			scene.idle(26);
			scene.world.modifyEntity(squid, Entity::animateHurt);
			// scene.world.modifyEntity(blaze, entity -> entity.hurt(entity.damageSources().generic(), 100.0F));
			scene.idle(7);
		...
		public static void crushingFungus(SceneBuilder scene, SceneBuildingUtil util) {
			...
			ElementLink<EntityElement> crushedShroomlightEntity = scene.world.createItemEntity(util.vector.of(2, 3, 2).add(0, -1.4, 0), util.vector.of(0, 0, 0), shroomlight1);
			scene.idle(4);
