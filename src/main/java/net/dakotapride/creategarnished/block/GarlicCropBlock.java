...
public class GarlicCropBlock extends CropBlock implements BonemealableBlock {
    ...
    public String getDescriptionId() {
        return "block.creategarnished.garlic";
    }
    ...
    protected @NotNull ItemLike getBaseSeedId() {
        return CreateGarnishedItems.GARLIC_BULB.get();
    }
