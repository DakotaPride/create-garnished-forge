...
public class CreateGarnishedItems {
    ...
    public static final ItemEntry<GingerRootItem> GINGER_ROOT = CreateGarnished.REGISTRATE.item("ginger_root", GingerRootItem::new)
            .properties(p -> p.food(new FoodProperties.Builder().nutrition(2).saturationMod(0.6F).build()))
            .register();
    ...
    public static final ItemEntry<Item> PEANUT_BUTTER_BOTTLE = CreateGarnished.REGISTRATE.item("peanut_butter_bottle", Item::new)
            .properties(p -> p.food(new FoodProperties.Builder().nutrition(3).saturationMod(0.6F).build()))
            .register();
    ...
    public static final ItemEntry<ElvenSweetberriesItem> ELVEN_SWEET_BERRIES = CreateGarnished.REGISTRATE.item("elven_sweet_berries", ElvenSweetberriesItem::new)
            .properties(p -> p.food(new FoodProperties.Builder().nutrition(2).saturationMod(0.4F).effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 400, 0), 1.0F).build()))
            .register();
    ...
    public static final ItemEntry<BowlFoodItem> VEGETABLE_STEW = CreateGarnished.REGISTRATE.item("vegetable_stew", BowlFoodItem::new)
            .properties(p -> p.stacksTo(1).food(new FoodProperties.Builder().nutrition(8).saturationMod(0.6F)
    ...
    public static final ItemEntry<Item> PRALINE = CreateGarnished.REGISTRATE.item("praline", Item::new)
            .properties(p -> p.stacksTo(16).food(new FoodProperties.Builder().nutrition(8).saturationMod(0.6F)
    ...
    public static final ItemEntry<Item> BEAR_CLAW = CreateGarnished.REGISTRATE.item("bear_claw", Item::new)
            .properties(p -> p.stacksTo(16).food(new FoodProperties.Builder().nutrition(6).saturationMod(0.6F)
    ...
    public static final ItemEntry<Item> CHURCHKHELA = CreateGarnished.REGISTRATE.item("churchkhela", Item::new)
            .properties(p -> p.stacksTo(16).food(new FoodProperties.Builder().nutrition(6).saturationMod(0.6F).build()))
            .register();
