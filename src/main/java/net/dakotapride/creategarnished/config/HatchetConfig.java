...
public class HatchetConfig extends ConfigBase {
    ...
    public ConfigInt chanceToDropLeather = i(65, 0, 100, "chanceToDropLeather", Comments.chanceToDropLeather);
    ...
    public ConfigInt chanceToDropGoldNugget = i(5, 0, 100, "chanceToDropGoldNugget", Comments.chanceToDropGoldNugget);
    ...
    public ConfigInt chanceToDropCopperNugget = i(5, 0, 100, "chanceToDropCopperNugget", Comments.chanceToDropCopperNugget);
    ...
    public ConfigInt chanceToDropBoneMeal = i(45, 0, 100, "chanceToDropBoneMeal", Comments.chanceToDropBoneMeal);
    ...
    public ConfigInt chanceToDropMossBlock = i(20, 0, 100, "chanceToDropMossBlock", Comments.chanceToDropMossBlock);
    ...
    public ConfigInt chanceToDropExtraCoal = i(20, 0, 100, "chanceToDropExtraCoal", Comments.chanceToDropExtraCoal);
    ...
    public ConfigInt chanceToDropElasticStrand = i(25, 0, 100, "chanceToDropElasticStrand", Comments.chanceToDropElasticStrand);
    ...
    public ConfigInt chanceToDropExtraSlimeBalls = i(15, 0, 100, "chanceToDropSlimeBall", Comments.chanceToDropExtraSlimeBalls);
    ...
    public ConfigInt chanceToDropExtraMagmaCream = i(15, 0, 100, "chanceToDropExtraMagmaCream", Comments.chanceToDropExtraMagmaCream);
    ...
    public ConfigInt chanceToDropExtraShulkerShells = i(15, 0, 100, "chanceToDropExtraShulkerShells", Comments.chanceToDropExtraShulkerShells);
    ...
    public ConfigInt chanceToDropExtraGlowstoneDust = i(15, 0, 100, "chanceToDropExtraGlowstoneDust", Comments.chanceToDropExtraGlowstoneDust);
    public ConfigInt glowstoneDustMaxCount = i(2, 1, "glowstoneDustMaxCount", Comments.glowstoneDustMaxCount);
    public ConfigInt chanceToDropExtraRedstoneDust = i(0, 0, 100, "chanceToDropExtraRedstoneDust", Comments.chanceToDropExtraRedstoneDust);
    public ConfigInt redstoneDustMaxCount = i(1, 1, "redstoneDustMaxCount", Comments.redstoneDustMaxCount);
    public ConfigInt chanceToDropNetherWart = i(0, 0, 100, "chanceToDropNetherWart", Comments.chanceToDropNetherWart);
    ...
    public ConfigInt chanceToDropExtraPhantomMembranes = i(25, 0, 100, "chanceToDropExtraPhantomMembranes", Comments.chanceToDropExtraPhantomMembranes);
    ...
    public ConfigInt chanceToDropZincNugget = i(15, 0, 100, "chanceToDropZincNugget", Comments.chanceToDropZincNugget);
    ...
    public ConfigInt chanceToDropSnifferFluff = i(80, 0, 100, "chanceToDropSnifferFluff", Comments.chanceToDropSnifferFluff);
    ...
    public ConfigInt chanceToDropExtraPrismarineShards = i(40, 0, 100, "chanceToDropExtraPrismarineShards", Comments.chanceToDropExtraPrismarineShards);
    public ConfigInt prismarineShardMaxCount = i(4, 1, "prismarineShardMaxCount", Comments.prismarineShardMaxCount);
    public ConfigInt chanceToDropExtraPrismarineCrystals = i(25, 0, 100, "chanceToDropExtraPrismarineCrystals", Comments.chanceToDropExtraPrismarineCrystals);
    ...
    public ConfigInt chanceToDropGuardianSpike = i(70, 0, 100, "chanceToDropGuardianSpike", Comments.chanceToDropGuardianSpike);
    ...
    public ConfigInt chanceToDropElderGuardianSpike = i(70, 0, 100, "chanceToDropElderGuardianSpike", Comments.chanceToDropElderGuardianSpike);
    ...
    public ConfigInt chanceToDropGunpowder = i(40, 0, 100, "chanceToDropGunpowder", Comments.chanceToDropExtraGunpowder);
    ...
    public ConfigInt chanceToDropExtraGhastTear = i(40, 0, 100, "chanceToDropGhastTear", Comments.chanceToDropExtraGhastTear);
    ...
    public ConfigInt chanceToDropExtraBreezeRod = i(40, 0, 100, "chanceToDropExtraBreezeRod", Comments.chanceToDropExtraBreezeRod);
    ...
    public ConfigInt chanceToDropExtraBlazeRod = i(40, 0, 100, "chanceToDropExtraBlazeRod", Comments.chanceToDropExtraBlazeRod);
    ...
    public ConfigInt chanceToDropExtraEnderPearl = i(40, 0, 100, "chanceToDropExtraEnderPearl", Comments.chanceToDropExtraEnderPearl);
    ...
    public ConfigInt chanceToDropExtraInkSac = i(40, 0, 100, "chanceToDropExtraInkSac", Comments.chanceToDropExtraInkSac);
    ...
    public ConfigInt chanceToDropExtraGlowInkSac = i(40, 0, 100, "chanceToDropExtraGlowInkSac", Comments.chanceToDropExtraGlowInkSac);
    ...
    public ConfigInt chanceToDropExtraString = i(40, 0, 100, "chanceToDropExtraString", Comments.chanceToDropExtraString);
    ...
    public final ConfigGroup voltfish = group(1, "voltfish", "Controls drops from the Voltfish mob.");
    public ConfigBool enableVoltfishAnomaly = b(true, "enableVoltfishAnomaly", Comments.enableVoltfishAnomaly);
    public ConfigInt chanceToDropExtraVoltfishMeat = i(25, 0, 100, "chanceToDropExtraVoltfishMeat", Comments.chanceToDropExtraVoltfishMeat);
    public ConfigInt extraVoltfishMeatMaxCount = i(2, 0, "extraVoltfishMeatMaxCount", Comments.extraVoltfishMeatMaxCount);
    public ConfigInt chanceToDropExtraVoltfishScales = i(15, 0, 100, "chanceToDropExtraVoltfishScales", Comments.chanceToDropExtraVoltfishScales);
    public ConfigInt extraVoltfishScalesMaxCount = i(1, 0, "extraVoltfishScalesMaxCount", Comments.extraVoltfishScalesMaxCount);
    public ConfigInt chanceToDropVoltfishOrgans = i(15, 0, 100, "chanceToDropVoltfishOrgans", Comments.chanceToDropVoltfishOrgans);
    public ConfigInt voltfishOrgansMaxCount = i(2, 0, "voltfishOrgansMaxCount", Comments.voltfishOrgansMaxCount);
    ...
    private static class Comments {
        ...
        //
        static String chanceToDropExtraVoltfishMeat = "The chance to drop extra pieces of voltfish Meat upon defeat.";
        static String extraVoltfishMeatMaxCount = "Max count for extra voltfish meat to drop upon defeat.";
        static String chanceToDropExtraVoltfishScales = "The chance to drop extra pieces of toughened scales upon defeat.";
        static String extraVoltfishScalesMaxCount = "Max count for extra toughened scales to drop upon defeat.";
        static String chanceToDropVoltfishOrgans = "The chance to drop volatile organs upon defeat.";
        static String voltfishOrgansMaxCount = "Max count for volatile organs to drop upon defeat.";
    }
}
