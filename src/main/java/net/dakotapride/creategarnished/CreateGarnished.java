...
import net.dakotapride.creategarnished.entity.bucketfish.client.BucketfishRenderer;
...
//    }
    ...
    public static class ClientModEvents {
        ...
        public static void onClientSetup(FMLClientSetupEvent event) {
            ...
            EntityRenderers.register(CreateGarnishedEntityTypes.BUCKETFISH.get(), BucketfishRenderer::new);
        }
