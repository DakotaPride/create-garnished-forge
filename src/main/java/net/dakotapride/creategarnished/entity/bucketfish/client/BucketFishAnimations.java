...
public class BucketFishAnimations {
	public static final AnimationDefinition ANIM_BUCKETFISH_IDLE = AnimationDefinition.Builder.withLength(2.0F).looping()
		.addAnimation("outer", new AnimationChannel(AnimationChannel.Targets.SCALE, 
			...
			new Keyframe(1.125F, KeyframeAnimations.scaleVec(1.05F, 1.05F, 1.05F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition ANIM_BUCKETFISH_SWIM = AnimationDefinition.Builder.withLength(2.0F).looping()
		...
		.addAnimation("legs", new AnimationChannel(AnimationChannel.Targets.POSITION,
			...
			new Keyframe(1.25F, KeyframeAnimations.posVec(0.0F, 0.5F, 0.5F), AnimationChannel.Interpolations.LINEAR),
